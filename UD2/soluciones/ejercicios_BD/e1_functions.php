...
define('DB_DSN', 'mysql:host=mariadb;dbname=e_231');
define('DB_USER', 'root');
...
function alta_usuario(
    ...
    $toret = false;
    try {
        $toret = $query->execute() ?: 'Error 100: No se ha podido almacenar el usuario';
    } catch (PDOException $e) {
        $toret = 'Error 101: No se ha podido almacenar el usuario';
    } finally {
