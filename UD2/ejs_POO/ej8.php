...
$wey1 = new Estudiante("Juan", 15, $direc, 4, []);
$wey2 = new Estudiante("Felipe", 17, $direc, 6, []);
$primero = new Curso([]);
$primero->addEstudiante($wey1);
$primero->addEstudiante($wey2);
$primero->mostrarEstudiantes();